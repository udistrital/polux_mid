...
func init() {
	...
	beego.GlobalControllerRouter["github.com/udistrital/polux_mid/controllers:VerificarBase64Controller"] = append(beego.GlobalControllerRouter["github.com/udistrital/polux_mid/controllers:VerificarBase64Controller"],
		beego.ControllerComments{
			Method:           "PostVerificarBase64",
			Router:           "/",
			AllowHTTPMethods: []string{"post"},
			MethodParams:     param.Make(),
			Filters:          nil,
