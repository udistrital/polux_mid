...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/polux_mid/controllers:SolicitudesController"] = append(beego.GlobalControllerRouter["github.com/udistrital/polux_mid/controllers:SolicitudesController"],
        beego.ControllerComments{
            Method: "Post",
            Router: "/",
            AllowHTTPMethods: []string{"post"},
