...
func AddTransaccionRespuestaSolicitud(transaccion *models.TrRespuestaSolicitud) (response map[string]interface{}, outputError map[string]interface{}) {
	...
	if transaccion.TrTrabajoGrado != nil && ((parametro.CodigoAbreviacion != "EAPOS_PLX" && parametro.CodigoAbreviacion != "EAPRO_PLX" && (parametroEstadoSolicitud.CodigoAbreviacion == "ACPR_PLX" || parametroEstadoSolicitud.CodigoAbreviacion == "ADD_PLX" || parametroEstadoSolicitud.CodigoAbreviacion == "APEP_PLX")) || transaccion.MateriasProPos) {
