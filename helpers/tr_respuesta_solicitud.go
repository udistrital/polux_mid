...
func AddTransaccionRespuestaSolicitud(transaccion *models.TrRespuestaSolicitud) (alerta []string, outputError map[string]interface{}) {
	...
	if err := request.GetRequestNew("UrlCrudParametros", url, &parametro); err != nil {
		logs.Error(err.Error())
		panic(err.Error())
	}
	url = "parametro/" + strconv.Itoa(transaccion.RespuestaAnterior.EstadoSolicitud)
	if err := request.GetRequestNew("UrlCrudParametros", url, &parametroEstadoSolicitud); err != nil {
		logs.Error(err.Error())
		panic(err.Error())
	}
	...
	if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resRespuestaAnterior, &transaccion.RespuestaAnterior); err == nil {
		url = "/v1/respuesta_solicitud"
		var resRespuestaNueva map[string]interface{}
		if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resRespuestaNueva, &transaccion.RespuestaNueva); err == nil {
			...
			if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resDocumentoSolicitud, &transaccion.DocumentoSolicitud); err == nil {
	...
	if transaccion.TrTrabajoGrado != nil && (parametro.CodigoAbreviacion != "EAPOS_PLX" || parametroEstadoSolicitud.CodigoAbreviacion == "ACPR_PLX") {
		...
		if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resTrabajoGrado, &transaccion.TrTrabajoGrado.TrabajoGrado); err == nil {
			...
			if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resSolicitudTrabajoGrado, &transaccion.SolicitudTrabajoGrado); err == nil {
				...
				for i, v := range *transaccion.TrTrabajoGrado.AsignaturasTrabajoGrado {
					...
					if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resAsignaturaTrabajoGrado, &v); err == nil {
				...
				for i, v := range *transaccion.TrTrabajoGrado.EstudianteTrabajoGrado {
					...
					v.TrabajoGrado.Id = idTrabajoGrado
					if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resEstudianteTrabajoGrado, &v); err == nil {
				...
				if transaccion.TrTrabajoGrado.AreasTrabajoGrado != nil {
					...
					for i, v := range *transaccion.TrTrabajoGrado.AreasTrabajoGrado {
						...
						v.TrabajoGrado.Id = idTrabajoGrado
						if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resAreasTrabajoGrado, &v); err == nil {
				...
				if transaccion.TrTrabajoGrado.VinculacionTrabajoGrado != nil {
					...
					for i, v := range *transaccion.TrTrabajoGrado.VinculacionTrabajoGrado {
						...
						v.TrabajoGrado.Id = idTrabajoGrado
						if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resVinculacionTrabajoGrado, &v); err == nil {
				...
				if transaccion.TrTrabajoGrado.DocumentoEscrito != nil {
					...
					if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resDocumentoEscrito, &transaccion.TrTrabajoGrado.DocumentoEscrito); err == nil { // Se guarda el documento con tipo_documento = DTR_PLX
						...
						if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resDocumentoTrabajoGrado, &transaccion.TrTrabajoGrado.DocumentoTrabajoGrado); err == nil { //Se asocia el documento con el trabajo de grado
							...
							url = "/v1/documento_escrito"
							var resDocumentoEscrito map[string]interface{}
							if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resDocumentoEscrito, &TrAnteproyecto.TrTrabajoGrado.DocumentoEscrito); err == nil { // Se guarda el documento con tipo_documento = ANP_PLX
								...
								url = "/v1/documento_trabajo_grado"
								if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resDocumentoTrabajoGradoAnt, &TrAnteproyecto.TrTrabajoGrado.DocumentoTrabajoGrado); err == nil { //Se asocia el anteproyecto con el trabajo de grado
				...
				if transaccion.EspaciosAcademicosInscritos != nil {
					...
					for i, v := range *transaccion.EspaciosAcademicosInscritos {
						...
						v.TrabajoGrado.Id = idTrabajoGrado
						if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resEspaciosAcademicosInscritos, &v); err == nil {
				...
				if transaccion.DetallesPasantia != nil {
					...
					if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resDetallePasantia, &transaccion.DetallesPasantia); err == nil {
				...
				if transaccion.DetallesPasantiaExterna != nil && parametro.CodigoAbreviacion == "PASEX_PLX" {
					...
					for i, v := range *transaccion.DetallesPasantiaExterna {
						...
						v.TrabajoGrado.Id = idTrabajoGrado
						if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resDetallesPasantiaExterna, &v); err == nil {
	...
	if transaccion.Vinculaciones != nil {
		...
		for _, v := range *transaccion.Vinculaciones {
			...
			if v.Activo {
				...
				if vinculado[0].Id != 0 {
					...
					if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resVinculacionTrabajoGrado, &vinculado[0]); err == nil {
				...
				if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resVinculacionTrabajoGrado, &v); err == nil {
		...
		if len(revisionTrabajoGrado) > 0 {
			...
			if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resRevisionTrabajoGrado, &revisionTrabajoGrado[0]); err != nil {
		...
		if transaccion.DetallesPasantia != nil {
			...
			if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resDetallePasantia, &detallePasantia); err != nil {
				rollbackRevisionTrabajoGrado(&vinc_orig, vinculaciones_originales_trabajo_grado, vinculaciones_trabajo_grado_post)
			}
		}
	}
	...
	if transaccion.TrabajoGrado != nil {
		...
		if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resTrabajoGrado, &transaccion.TrabajoGrado); err != nil {
			logs.Error(err)
			rollbackDocumentoSolicitud(transaccion)
		}
	}
	...
	if err := request.GetRequestNew("UrlCrudParametros", url, &parametroTipoSolicitud); err != nil {
		logs.Error(err.Error())
		panic(err.Error())
	}
	...
	if parametroTipoSolicitud.CodigoAbreviacion == "SPR_PLX" {
		if transaccion.CausaProrroga != nil {
			for _, data := range *transaccion.CausaProrroga {
				...
				if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resDetalleTrabajoGrado, &data); err != nil {
					logs.Error(err)
					rollbackDocumentoSolicitud(transaccion)
				}
			}
	...
	if transaccion.EstudianteTrabajoGrado != nil {
		...
		if err := request.GetRequestNew("UrlCrudParametros", url, &parametroEstadoEstudianteTrGr); err != nil {
			logs.Error(err.Error())
			panic(err.Error())
		}
		...
		if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resEstudianteTrabajoGrado, &transaccion.EstudianteTrabajoGrado); err == nil {
			...
			if estudianteTrabajoGradoAux[0].Id == 0 {
				...
				if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resTrabajoGrado, tg); err != nil {
					logs.Error(err)
					rollbackVincTrGrCanc(transaccion)
				}
				...
				if err := request.GetRequestNew("UrlCrudParametros", url, &parametroEstAsTrGr); err != nil {
					logs.Error(err.Error())
					panic(err.Error())
				}
				...
				for _, v := range asignaturasTrabajoGrado {
					...
					if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resAsignaturaTrabajoGrado, v); err == nil {
				...
				if err := request.GetRequestNew("UrlCrudParametros", url, &parametroEspAcadIns); err != nil {
					logs.Error(err.Error())
					panic(err.Error())
				}
				...
				if espaciosAcademicosInscritos[0].Id != 0 {
					...
					if err := request.GetRequestNew("UrlCrudParametros", url, &parametroEspAcadInsAux); err != nil {
						logs.Error(err.Error())
						panic(err.Error())
					}
					...
					for _, v := range espaciosAcademicosInscritos {
						...
						if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resEspacioAcademicoInscrito, v); err == nil {
	...
	if transaccion.TrRevision != nil {
		...
		if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &resTrabajoGrado, &transaccion.TrRevision.TrabajoGrado); err != nil {
			logs.Error(err)
			rollbackDocumentoSolicitud(transaccion)
		}
		...
		var resDocumentoEscrito map[string]interface{}
		url = "/v1/documento_escrito"
		if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resDocumentoEscrito, &transaccion.TrRevision.DocumentoEscrito); err == nil {
			...
			var resDocumentoTrabajoGrado map[string]interface{}
			url = "/v1/documento_trabajo_grado"
			if err := request.SendRequestNew("PoluxCrudUrl", url, "POST", &resDocumentoTrabajoGrado, &transaccion.TrRevision.DocumentoTrabajoGrado); err == nil {
...
func rollbackResAnterior(transaccion *models.TrRespuestaSolicitud) (outputError map[string]interface{}) {
	...
	url := "/v1/respuesta_solicitud/" + strconv.Itoa(transaccion.RespuestaAnterior.Id)
	if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &respuesta, &transaccion.RespuestaAnterior); err != nil {
...
func rollbackSolicitudTrabajoGrado(transaccion *models.TrRespuestaSolicitud) (outputError map[string]interface{}) {
	...
	url := "/v1/solicitud_trabajo_grado/" + strconv.Itoa(transaccion.SolicitudTrabajoGrado.Id)
	if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &respuesta, &transaccion.SolicitudTrabajoGrado); err != nil {
...
func rollbackVinculacionTrabajoGradoRS(transaccion *models.TrRespuestaSolicitud, vinculacionesOriginales []models.VinculacionTrabajoGrado) (outputError map[string]interface{}) {
	...
	for _, v := range vinculacionesOriginales {
		url := "/v1/vinculacion_trabajo_grado/" + strconv.Itoa(v.Id)
		if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &respuesta, &v); err != nil {
...
func rollbackVinculacionTrabajoGradoRSPost(transaccion *models.TrRespuestaSolicitud, vinculacionesNuevas []map[string]interface{}) (outputError map[string]interface{}) {
	...
	for _, v := range vinculacionesNuevas {
		...
		if err := request.SendRequestNew("PoluxCrudUrl", url, "DELETE", &respuesta, &vinculacionNueva); err != nil {
...
func rollbackRevisionTrabajoGrado(revisionAnterior *models.RevisionTrabajoGrado, vinc_orig []models.VinculacionTrabajoGrado, vinc_post []map[string]interface{}) (outputError map[string]interface{}) {
	...
	if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &respuesta, &revisionAnterior); err != nil {
...
func rollbackEstTrGrCanc(transaccion *models.TrRespuestaSolicitud) (outputError map[string]interface{}) {
	...
	if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &respuesta, &transaccion.EstudianteTrabajoGrado); err != nil {
...
func rollbackTrGrCanc(transaccion *models.TrRespuestaSolicitud) (outputError map[string]interface{}) {
	...
	if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &respuesta, transaccion.EstudianteTrabajoGrado.TrabajoGrado); err != nil {
		panic("Rollback vinculación trabajo grado cancelación" + err.Error())
	} else {
		rollbackVincTrGrCanc(transaccion)
	}
...
func rollbackTrGrRev(transaccion *models.TrRespuestaSolicitud) (outputError map[string]interface{}) {
	...
	if err := request.GetRequestNew("UrlCrudParametros", url, &parametroEstTrGr); err != nil {
		logs.Error(err.Error())
		panic(err.Error())
	}
	var respuesta map[string]interface{}
	...
	if err := request.SendRequestNew("PoluxCrudUrl", url, "PUT", &respuesta, transaccion.TrRevision.TrabajoGrado); err != nil {
